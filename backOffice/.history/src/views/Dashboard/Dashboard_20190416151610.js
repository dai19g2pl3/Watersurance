          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-info">
              <CardBody className="pb-0">
                ...
                <div className="text-value">1.758</div>
                <div>Clientes</div>
              </CardBody>
              ...
              <CardBody className="pb-0">
                <ButtonGroup className="float-right">
                  ...
                  >
                    ...
                    <DropdownMenu right>
                      <DropdownItem>Listar</DropdownItem>
                      <DropdownItem>Submeter</DropdownItem>
                    </DropdownMenu>
                  </ButtonDropdown>
                </ButtonGroup>
                <div className="text-value">351</div>
                <div>Ocorrências</div>
              </CardBody>
              <div className="chart-wrapper mx-3" style={{ height: "100px" }}>
                <Line
                    ...
                    <Row>
                      ...
                      <Col sm="6">
                        <div className="callout callout-danger">
                          ...
                          <br />
                          <strong className="h4">1,758</strong>
                          <div className="chart-wrapper">
                            <Line
                    ...
                    <Row>
                      <Col sm="6">
                        <div className="callout callout-warning">
                          ...
                          <br />
                          <strong className="h4">24.253</strong>
                          <div className="chart-wrapper">
                            <Line
                      ...
                      <Col sm="6">
                        <div className="callout callout-success">
                          <small className="text-muted">Pesquisas</small>
                          <br />
                          <strong className="h4">36.236</strong>
                          <div className="chart-wrapper">
                            <Line
                    ...
                    <ul>
                      <div className="progress-group">
                        <div className="progress-group-header">
                          ...
                          <span className="ml-auto font-weight-bold">57%</span>
                        </div>
                        <div className="progress-group-bars">
                          <Progress
                            className="progress-xs"
                      ...
                      <div className="progress-group mb-5">
                        <div className="progress-group-header">
                          ...
                          <span className="title">Feminino</span>
                      ...
                      <div className="progress-group">
                        <div className="progress-group-header">
                          ...
                          <span className="ml-auto font-weight-bold">
                            4.203 <span className="text-muted small">(8%)</span>
                          </span>
                        </div>
                        <div className="progress-group-bars">
                          <Progress
                ...
                >
                  <thead className="thead-light">
                    <tr>
                      ...
                      <th className="text-center">Metodo Pagamento</th>
                      <th>Atividade</th>
                    </tr>
                  </thead>
                  <tbody>
