...
import com.dai.watersurance.exception.BadRequestException;
...
import com.dai.watersurance.util.ModelMapper;
...
public class PollService {
    ...
    public PagedResponse<PollResponse> getPollsCreatedBy(String email, UserPrincipal currentUser, int page, int size) {
        validatePageNumberAndSize(page, size);
    ...
    public PagedResponse<PollResponse> getPollsVotedBy(String email, UserPrincipal currentUser, int page, int size) {
        validatePageNumberAndSize(page, size);
